...
class Details extends Component {
  ...
  updateAllValues = (number) => {
    ...
    this.setState({
      lengthValue: number,
      lengthValueInNM: this.getCalculatedValue(numberModified, 'N/m'),
      lengthValueInNCM: this.getCalculatedValue(numberModified, 'N/cm'),
      lengthValueInN25MM: this.getCalculatedValue(numberModified, 'N/25mm'),
      lengthValueInKGMILS: this.getCalculatedValue(numberModified, 'Kg/mils'),
      lengthValueInPIN: this.getCalculatedValue(numberModified, 'Pounds/In'),
      lengthValueInOIN: this.getCalculatedValue(numberModified, 'Ounces/In')
    });
  }
