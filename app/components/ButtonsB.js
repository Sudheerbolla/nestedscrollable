...
const SimpleBtnImage = (props) => {
  return (<TouchableOpacity style={props.buttonContainer} activeOpacity={0.5} onPress={props.pressHandler}>
    <ImageBackground source={GetImage(props.value)}/>
  </TouchableOpacity>)
}
...
export class BtnPercent extends Component {
  ...
  render() {
    return (<SimpleBtnImage buttonContainer={styles.buttonContainerOperation} pressHandler={this.pressHandler} buttonText={styles.buttonTextBlue} value={this.props.value}/>)
  }
}
