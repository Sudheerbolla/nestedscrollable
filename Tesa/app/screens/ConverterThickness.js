        ...
        <View style={styles.container}>
          <View style={{ flexDirection: 'row' }}>
            <View style={styles.unitFieldContainer}>
              <Text style={{ fontFamily: FONTS.FONT_BOLD }}>{applyLetterSpacing(i18n.t('converter_thickness.thickness').toUpperCase(), 1)}</Text>
              <TextInput
          ...
          <View style={styles.resultContainer}>
            <View style={{ flexDirection: 'column' }}>
              <Text style={{ fontFamily: FONTS.FONT_BOLD }}>{applyLetterSpacing(i18n.t('converter_thickness.result').toUpperCase(), 1)}</Text>
            </View>
            <View style={styles.result}>
              <View style={{ flexDirection: 'row' }}>
                <Text style={styles.unitResult}>{applyLetterSpacing('10000,00', 1)}</Text>
                <SupText style={styles.unitConverter} textStyle={{ fontFamily: FONTS.FONT_BOLD }} supStyle={{ fontFamily: FONTS.FONT_BOLD }} text={'mils'} />
              </View>
              <View style={{ flexDirection: 'row' }}>
                <Text style={styles.unitResult}>{applyLetterSpacing('1000,00', 1)}</Text>
                <SupText style={styles.unitConverter} textStyle={{ fontFamily: FONTS.FONT_BOLD }} supStyle={{ fontFamily: FONTS.FONT_BOLD }} text={'μm'} />
              </View>
            </View>
          </View>
        </View>
